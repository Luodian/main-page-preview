...
authors:
  ...
  - name: "Tat-Seng Chua"
  - name: "Ziwei Liu"
acknowledgement: "This groundbreaking work in multimodal mechanistic interpretability builds upon Anthropic's pioneering research in SAE-based feature interpretation, extending these methods to the multimodal domain for the first time."
bibtex: "@article{li2024multimodal-sae,\n  title={Large Multi-modal Models Can Interpret Features in Large Multi-modal Models},\n  author={Li, Shaozhi and Wang, Xiong and Zhang, Yue and Yang, Jingkang and Wang, Keze and Jiang, Zhengkai and Chua, Tat-Seng and Liu, Ziwei},\n  journal={arXiv preprint arXiv:2411.10982},\n  year={2024}\n}"
---
...
We provide comprehensive resources for the research community:

- 🚀 **[GitHub Repository](https://github.com/EvolvingLMMs-Lab/multimodal-sae)** - Complete implementation and code
- 📊 **Training Scripts** - SAE training and integration pipelines
- 🔧 **Interpretation Tools** - Auto-explanation pipeline implementation
- 📖 **Documentation** - Detailed guides for reproduction and extension
