...
mainTags: ["research"]
tags:
  ["vision", "models", "research", "egocentric", "multimodal", "life-assistant"]
...
<ResponsiveImage
  src="https://github.com/EvolvingLMMs-Lab/EgoLife/blob/main/assets/egolife_teaser.png?raw=true"
  alt="EgoLife Project Teaser"
  maxWidth="100%"
  caption="EgoLife: Towards Egocentric Life Assistant - A comprehensive project developing AI-powered wearable glasses for personal efficiency enhancement"
/>
