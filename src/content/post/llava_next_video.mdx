...
authors:
  - name: "LMMs-Lab Team"
    main: true
acknowledgement: "This work presents LLaVA-Video, a video large multimodal model trained on high-quality synthetic instruction-following data, demonstrating strong performance across video understanding benchmarks."
