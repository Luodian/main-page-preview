...
- 🌐 **[Project Website](https://videommmu.github.io/)** - Comprehensive benchmark information
- 📄 **[Research Paper](https://arxiv.org/abs/2501.13826)** - Detailed methodology and analysis
- 🤗 **[Dataset](https://huggingface.co/datasets/lmms-lab/VideoMMMU)** - Complete benchmark dataset
- 💻 **[GitHub Repository](https://github.com/EvolvingLMMs-Lab/VideoMMMU)** - Evaluation code and tools
