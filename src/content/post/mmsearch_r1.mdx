...
- 🚀 **[GitHub Repository](https://github.com/EvolvingLMMs-Lab/multimodal-search-r1)** - Complete implementation
- 📄 **[Research Paper](https://arxiv.org/abs/2506.00000)** - Detailed methodology and results
- 🤗 **[Model Checkpoints](https://huggingface.co/EvolvingLMMs-Lab/MMSearch-R1-7B)** - Pre-trained models
- 📊 **[FVQA Dataset](https://huggingface.co/datasets/EvolvingLMMs-Lab/FVQA)** - Training and evaluation data
